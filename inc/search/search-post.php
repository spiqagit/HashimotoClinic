    ...
    <div class="bl_blogArchiveListContainer_inner">
        ...
        <div class="bl_blogArchiveListContainer_navContainer">
            <nav class="bl_blogArchiveListContainer_nav">
                <div class="bl_blogArchiveListContainer_nav_searchContainer">
                    <?php $search_keyword = get_search_query(false); ?>
                    <form action="<?php echo esc_url(home_url('/')); ?>" class="bl_blogArchiveListContainer_nav_searchContainer_form" method="get">
                        <input type="hidden" name="type" value="post">
                        <input class="el_blogArchiveListContainer_nav_searchContainer_form_input" type="text" name="s" value="<?php echo esc_attr($search_keyword); ?>" placeholder="キーワードを入力">
        ...
        <div>
                ...
                ?>
                    <p class="bl_common_noResults">
                        <?php if ($search_keyword !== '') : ?>
                            「<?php echo esc_html($search_keyword); ?>」に一致する記事は見つかりませんでした。<br>別のキーワードでお試しください。
                        <?php else : ?>
            ...
            <div>
                ...
                $search_base_url = add_query_arg(['s' => $search_keyword, 'type' => 'post'], home_url('/'));
